...
/*   Updated: 2016/08/11 17:44:23 by anonymous        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	isprint_main(void)
{
	...
	while (i <= 127)
	{
		if ((isprint(i) != ft_isprint(i)) && (isprint(i) == 0 || ft_isprint(i) == 0))
			printf(KRED "FAILED!\n" RESET);
		i++;
	}
	printf(KGRN "OKAY! =D\n" RESET);
...
void	isalnum_main(void)
{
	...
	while (i <= 127)
	{
		if ((isalnum(i) != ft_isalnum(i)) && (isalnum(i) == 0 || ft_isalnum(i) == 0))
			printf(KRED "FAILED! std =%d ft=%d i=%d \n" RESET, isalnum(i), ft_isalnum(i), i);
		i++;
	}
	printf(KGRN "OKAY! =D\n" RESET);
}
...
void	isdigit_main(void)
{
	...
	while (i <= 127)
	{
		if ((isdigit(i) != ft_isdigit(i)) && (isdigit(i) == 0 || ft_isdigit(i) == 0))
			printf(KRED "FAILED!\n" RESET);
			i++;
	}
	printf(KGRN "OKAY! =D\n" RESET);
...
void	isalpha_main(void)
{
	...
	while (i <= 127)
	{
		if ((isalpha(i) != ft_isalpha(i)) && (isalpha(i) == 0 || ft_isalpha(i) == 0))
			printf(KRED "FAILED! i=%d isalpha=%d ft_isalpha=%d\n" RESET, i, isalpha(i), ft_isalpha(i));
		i++;
	}
	printf(KGRN "OKAY! =D\n" RESET);
}
